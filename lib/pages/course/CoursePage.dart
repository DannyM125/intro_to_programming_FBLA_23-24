...
import 'package:intro_to_programming_fbla/pages/course/Course.dart';
...
class CalculatorScreen extends StatefulWidget {
  @override
  CoursePage createState() => CoursePage();
}

class CoursePage extends State<CalculatorScreen> {
  ...
  static List<Course> courses_9 = [];
  static List<Course> courses_10 = [];
  static List<Course> courses_11 = [];
  static List<Course> courses_12 = [];
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      color: Colors.red,
                      onPressed: () {
                        removeCourse(getCourseList(selectedGradeLevel), index);
                      },
                    ),
                  );
                },
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                addCourse(getCourseList(selectedGradeLevel), courseNameController, selectedGradeLevel, selectedCredits, selectedLetterGrade);
                Navigator.of(context).pop();
              },
              child: Text('Add'),
            ),
  ...
  void removeCourse(List<dynamic> courseList, int index) {
    setState(() {
  ...
  void loadCourses() async {
    ...
    if (coursesJson != null) {
      List<Course> loadedCourses = coursesJson
